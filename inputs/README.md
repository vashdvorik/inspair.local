...
| `batches/` | Бэклог планирования: `pipeline.json`, `*.yaml` и заметки по будущим батчам. |
...
4. **Ссылки в батчах.** В `inputs/batches/*.yaml` указывайте конкретный путь и раздел (например, `inputs/requirements/api.md §3.2`).
